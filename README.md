...
| `understand`                | 自动扫描代码库并生成结构、语言、依赖、入口和架构知识图谱，帮助 Agent 快速理解项目                                                                                                                                                                                                                                                                                     |
| `understand-chat`           | 基于已生成的项目知识回答代码库问题                                                                                                                                                                                                                                                                                                                                     |
| `understand-dashboard`      | 生成代码库结构与健康状态仪表盘                                                                                                                                                                                                                                                                                                                                         |
| `understand-diff`           | 分析代码变更及其架构影响                                                                                                                                                                                                                                                                                                                                               |
| `understand-domain`         | 提取业务领域、实体、流程与边界上下文                                                                                                                                                                                                                                                                                                                                   |
| `understand-explain`        | 用结构化方式解释代码库、模块和实现逻辑                                                                                                                                                                                                                                                                                                                                 |
| `understand-figma`          | 扫描并合并 Figma 设计上下文到项目知识                                                                                                                                                                                                                                                                                                                                  |
| `understand-knowledge`      | 解析并合并项目知识库与知识图谱                                                                                                                                                                                                                                                                                                                                         |
| `understand-onboard`        | 为新成员生成基于代码库事实的上手指南                                                                                                                                                                                                                                                                                                                                   |
